<?php
$html_part_men_ob = '<!-- Logo Left, Nav Right, 100% Nav Bar : BEGIN -->	
			...
			<table border="0" width="600" cellpadding="0" cellspacing="0" align="center" style="margin: auto;" class="email-container">
			  ...
			  <tr>
				...
				<td class="hh-force-col-center" valign="middle" style="padding: 10px 0;text-align: right;">
				  ...
				  <a href="http://www.hami.com/Contact/default.php" style="color: #ffffff;font-family: sans-serif;">Kontakt</a>&nbsp;&nbsp;
				  <a href="http://www.hami.com/Search.php" style="color: #ffffff;font-family: sans-serif;">Suche</a>
				</td>
			  </tr>
			  <tr>
				<td height="10" style="font-size: 0; line-height: 0;">&nbsp;</td>
