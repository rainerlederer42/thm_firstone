...
echo "<h2>xxxxxxx vorher </h2>";
						echo "<p>Ihre yxyxyxyxyxyxyxxyxyxy  Registrierung wurde erfolgreich abgeschlossen. Sie können sich ab sofort mit Ihren Zugangsdaten <a href='sbs_login.php' class='btn btn-small btn-info'>anmelden</a></p>";
						echo "<p class='text-info'>An die angegebene E-Mail Adresse wurde automatisch eine Best&auml;tigung der erfolgten XXXXXXXXXXXXXX verschickt.</p>";		
...
echo "<h2>xxxxxxx abgeschlossen</h2>";
						echo "<p>Ihre yxyxyxyxyxyxyxxyxyxy  Registrierung wurde erfolgreich abgeschlossen. Sie können sich ab sofort mit Ihren Zugangsdaten <a href='sbs_login.php' class='btn btn-small btn-info'>anmelden</a></p>";
						echo "<p class='text-info'>An die angegebene E-Mail Adresse wurde automatisch eine Best&auml;tigung der erfolgten XXXXXXXXXXXXXX verschickt.</p>";		
